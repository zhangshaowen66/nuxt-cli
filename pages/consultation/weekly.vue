      ...
      <b-row>
        <b-col md="12" class="bg-080808 cl-ff newsTitle" >
          <b-row>
            <b-col md="1"></b-col>
            <b-col md="7">
              <h2>{{ $t('consultation.项目周报') }}</h2>
              <p v-if="langs !== 'en'">Project weekly</p>
            </b-col>
            <b-col md="3">
              <img width="100%" src="~/static/images/news/weekly.png" alt="">
            </b-col>
          </b-row>
        </b-col>
        <b-col md="12" class="newList" v-for="(item,i) in list" :key="i"><b-link :to="localePath(`/consultation/weekly-details?newsId=${item.id}`)"  class="cl-00">{{ item.title }}</b-link></b-col>
